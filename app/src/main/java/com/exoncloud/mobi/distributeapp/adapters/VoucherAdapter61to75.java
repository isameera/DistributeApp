...
public class VoucherAdapter61to75 extends RecyclerView.Adapter<VoucherAdapter61to75.VoucherHolder> {
    ...
    public VoucherAdapter61to75(ArrayList<Voucher> data, Activity activity, Context context) {
        this.mData = data;
    ...
    public VoucherHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_voucher_61to75, parent, false);
