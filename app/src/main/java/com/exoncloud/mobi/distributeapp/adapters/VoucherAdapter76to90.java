...
public class VoucherAdapter76to90 extends RecyclerView.Adapter<VoucherAdapter76to90.VoucherHolder> {
    ...
    public VoucherAdapter76to90(ArrayList<Voucher> data, Activity activity, Context context) {
        this.mData = data;
