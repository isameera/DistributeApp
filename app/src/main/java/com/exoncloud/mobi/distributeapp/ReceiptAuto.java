...
public class ReceiptAuto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_receipt_auto);
        ...
        TextView receipt_customer = (TextView) findViewById(R.id.receipt_customer);
        TextView total_invoice_amount = (TextView) findViewById(R.id.invoice_total);
        TextView total_invoice_paid_amount = (TextView) findViewById(R.id.invoice_paid);
        TextView total_invoice_due_amount = (TextView) findViewById(R.id.invoice_due);

        receipt_customer.setText(MainActivity.customer_name);
        total_invoice_amount.setText(MainActivity.total_invoice_amount);
        total_invoice_paid_amount.setText(MainActivity.total_invoice_paid_amount);
        total_invoice_due_amount.setText(MainActivity.total_invoice_due_amount);
        ...
        date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // date picker dialog
                datePickerDialog = new DatePickerDialog(ReceiptAuto.this,
            ...
            public void onClick(View v) {
                ...
                if(COC == 1){
                    ...
                    if(current_payment_text.isEmpty()){
                        ...
                        Toast.makeText(ReceiptAuto.this, "Fields cannot be empty!", Toast.LENGTH_SHORT).show();

                    }else{

                        saveReceipt(MainActivity.customer_id, current_payment,"-","-",0,"-",chequeController,1);
                        Toast.makeText(ReceiptAuto.this, "Successfully Saved!", Toast.LENGTH_SHORT).show();
                        ReceiptAuto.this.finish();
                    }
                    ...
                    if(current_payment_text.isEmpty() || cheque_number.isEmpty() || cheque_date.isEmpty() || bank_text.isEmpty() || bank_branch.isEmpty() || COC == 0 || chequeController==0){
                        ...
                        Toast.makeText(ReceiptAuto.this, "Fields cannot be empty or not selected!", Toast.LENGTH_SHORT).show();
...
//                    Toast.makeText(Receipt.this, "invoice_id_static: "+invoice_id_static +" current_payment: "+ current_payment+" cheque_number: "+cheque_number+" cheque_date: "+cheque_date+" bank: "+bank+" bank_branch: "+bank_branch+" chequeController: "+chequeController+" COC: "+COC, Toast.LENGTH_SHORT).show();
                        ...
                        saveReceipt(MainActivity.customer_id, current_payment,cheque_number,cheque_date,bank,bank_branch,chequeController,COC);
                        Toast.makeText(ReceiptAuto.this, "Successfully Saved!", Toast.LENGTH_SHORT).show();
                        ReceiptAuto.this.finish();
                    }
    ...
    public class FetchDataTaskSearchBank extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... param) {
            ...
            client.get("http://173.212.247.25/distribution_restful_api_test/resources/banks-list/0", null,  new JsonHttpResponseHandler() {
                ...
                public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONObject errorResponse) {
                    ...
                    Toast.makeText(ReceiptAuto.this, "Request Failed...", Toast.LENGTH_SHORT).show();
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            ArrayAdapter<String> adapter = new ArrayAdapter<String>(ReceiptAuto.this,
    ...
    private void saveReceipt(int customerId, double paymentD, String chequeNo, String chequeDate, int bank, String bank_branch, int chequeController, int coc) {

//        final String URL = "http://173.212.247.25/distribution_restful_api_test/resources/receipt-save/";
        final String URL = "http://173.212.247.25/distribution_restful_api_test/resources/receipt-save-auto/?customerId="+customerId+"&paymentD="+paymentD+"&chequeNo="+chequeNo+"&chequeDate="+chequeDate+"&bank="+bank+"&bank_branch="+bank_branch+"&chequeController="+chequeController+"&coc="+coc+"&description="+id+"&gupId="+gup+"&orgId="+org+"&LS="+ls+"&UL="+ul;
...
//        params.put("coc", coc);
        ...
        client.post(URL, new AsyncHttpResponseHandler() {
            ...
            public void onFailure(int statusCode, Header[] headers, byte[] responseBody, Throwable
                ...
                Toast.makeText(ReceiptAuto.this, "error:"+error, Toast.LENGTH_SHORT).show();
