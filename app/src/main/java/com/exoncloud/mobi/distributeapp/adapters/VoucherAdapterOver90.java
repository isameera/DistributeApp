...
public class VoucherAdapterOver90 extends RecyclerView.Adapter<VoucherAdapterOver90.VoucherHolder> {
    ...
    public VoucherAdapterOver90(ArrayList<Voucher> data, Activity activity, Context context) {
        this.mData = data;
