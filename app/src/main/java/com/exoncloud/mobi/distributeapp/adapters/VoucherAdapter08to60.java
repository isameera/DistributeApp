...
public class VoucherAdapter08to60 extends RecyclerView.Adapter<VoucherAdapter08to60.VoucherHolder> {
    ...
    public VoucherAdapter08to60(ArrayList<Voucher> data, Activity activity, Context context) {
        this.mData = data;
    ...
    public VoucherHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_voucher_08to60, parent, false);
