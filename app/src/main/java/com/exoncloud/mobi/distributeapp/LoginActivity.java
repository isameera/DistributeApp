...
//    }
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            client.get("http://173.212.247.25/distribution_restful_api_test/resources/login/"+mEmail+","+mPassword, null,  new JsonHttpResponseHandler() {
                @Override
                public void onSuccess(int statusCode, Header[] headers, JSONArray response) {
                    ...
                    try{
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            ...
                            gupId = jsonObject.getInt("gup");
                            orgId = jsonObject.getInt("org");
                            ls = jsonObject.getInt("ls");
                            ul = jsonObject.getInt("ul");
...
//                finish();
                ...
                // Use user real data
                session.createLoginSession(firstName+" "+lastName,id, ls,ul,gupId,orgId);
